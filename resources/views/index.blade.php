        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="m-0"><i class="fa fa-server me-3"></i>Alpha Cyber </h1>
                    <h1 class="m-0" style="font-size: smaller;"><i class="fa me-3"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Solution</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="about.html" class="nav-item nav-link">Produk & Layanan</a>
                        <a href="domain.html" class="nav-item nav-link">Berita</a>
                        <a href="hosting.html" class="nav-item nav-link">Agenda</a>
                        <a href="hosting.html" class="nav-item nav-link">Tentang Kami</a>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-6 pt-5 text-center text-lg-start">
                            {{-- <h3 class="display-4 text-white mb-4 animated slideInLeft">Layanan IT Terbaik</h3> --}}
                            <p class="text-white animated slideInLeft" style="font-size: 30px;"><b>Layanan IT terbaik</b> untuk seluruh <br> kebutuhan bisnis anda</p>

                            <div class="col-lg-6 text-center text-lg-start">
                            
                        </div>
                            <a href="" class="btn btn-secondary py-sm-3 px-sm-5 me-3 animated slideInLeft">hubungi Kami</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-start">
